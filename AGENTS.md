...
Preserve managed markers and never edit Local’s generated runtime config. Proxy only read-only, policy-approved missing assets below `/wp-content/uploads/`; strip credentials and cookies. Treat URLs, IPs, certificates, asset eligibility, and filesystem boundaries as security-sensitive.
