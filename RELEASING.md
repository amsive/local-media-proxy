...
9. Run `node scripts/verify-release-package.js v<version> dist/local-media-proxy-<version>.tgz`.
...
11. Install that exact archive into the minimum supported Local version and complete the end-to-end checklist in `CONTRIBUTING.md`, including the Installed Add-ons card, Overview and Release notes tabs, and both renderer themes.
...
3. Download and install the attached `.tgz`, then complete the release smoke test.
