...
export function buildManagedApacheConfig(
	...
	return [
		...
		'\tRequestHeader unset X-HTTP-Method-Override env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Method-Override env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-HTTP-Method env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Original-Method env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Original-URL env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Rewrite-URL env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Original-URI env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Forwarded-Uri env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Forwarded-Path env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Forwarded-Prefix env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Original-Host env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Forwarded-Client-Cert env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Client-Cert env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-SSL-Client-Cert env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-ARR-ClientCert env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Access-Token env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Id-Token env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Refresh-Token env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Amz-Security-Token env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset X-Amz-Credential env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset CF-Access-Client-Id env=LOCAL_MEDIA_PROXY_ORIGIN',
		'\tRequestHeader unset CF-Access-Client-Secret env=LOCAL_MEDIA_PROXY_ORIGIN',
