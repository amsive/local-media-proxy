...
1. Download \`local-media-proxy-<version>.tgz\` from the matching [GitHub release](https://github.com/amsive/local-media-proxy/releases).
	...
	return {
		data: {
			addon: {
				...
				releases: [
					{
						downloadUrl: `https://github.com/amsive/local-media-proxy/releases/download/v${ADDON_VERSION}/local-media-proxy-${ADDON_VERSION}.tgz`,
